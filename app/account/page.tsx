...
<div className="w-16 h-16 min-w-[64px] min-h-[64px] rounded-full bg-black text-white flex items-center justify-center text-2xl font-semibold">
D
</div>

<div className="flex-1">
<h2 className="text-3x1 font-bold text-zinc-900">
Dependu Das
</h2>
