...
<th className="text-left px-4 py-3 text-black font-semibold">Amount</th>
<th className="text-left px-4 py-3 text-black font-semibold">Currency</th>
...
<th className="text-left px-4 py-3 text-black font-semibold">Payment Date</th>
<th className="text-left px-4 py-3 text-black font-semibold">Invoice</th>
</tr>
</thead>
